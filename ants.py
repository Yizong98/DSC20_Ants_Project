...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        """
        # BEGIN Problem 5
        place_double = self.place
        while place_double != hive:
            if place_double.bees != []:
                return random_or_none(place_double.bees)
            else:
                place_double = place_double.entrance
        return None
...
class ShortThrower(ThrowerAnt):
    ...
    def nearest_bee(self, hive):
        ...
        tracker = 0
        while place_double != hive:
            if place_double.bees != [] and tracker <= self.max_range:
                return random_or_none(place_double.bees)
            else:
                place_double = place_double.entrance
            tracker += 1
...
def make_slow(action):
    ...
    def slower_bee_act(colony):
        if colony.time % 2 == 0:
        	return action(colony)
    return slower_bee_act
    # END Problem EC
